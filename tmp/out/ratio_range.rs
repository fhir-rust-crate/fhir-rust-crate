...
#[serde(deny_unknown_fields)]
    ...
    /// Low Numerator limit
    pub low_numerator: Option<types::Quantity>, // Quantity [0..1]

    /// High Numerator limit
    pub high_numerator: Option<types::Quantity>, // Quantity [0..1]

    /// Denominator value
    pub denominator: Option<types::Quantity>, // Quantity [0..1]
