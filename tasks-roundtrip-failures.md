...
## Summary (baseline: FHIR R5 5.0.0 example set, generated by T2)

| Result | Count |
|---|---:|
| Files scanned | 2824 |
| **Passed** | **2760** |
| Deserialize failures | 10 |
| Round-trip mismatches | 54 |

97.7% of the official example set already round-trips. Every remaining failure
falls into one of the five categories below. Categories A–B are the bulk and are
already planned work (Phase 1 primitive extensions); categories C–E are smaller,
mostly-unmapped model bugs that are cheap independent wins.
