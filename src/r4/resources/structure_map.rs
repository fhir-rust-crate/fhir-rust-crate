...
///
/// ```ignore
/// use fhir::r4::resources::structure_map::StructureMap;
///
...
///
/// ```ignore
/// use fhir::r4::resources::structure_map::StructureMapGroup;
///
...
pub struct StructureMapGroup {
    ...
    pub type_mode: crate::coded::Coded<crate::r4::codes::MapGroupTypeMode>,
...
///
/// ```
/// use fhir::r4::resources::structure_map::StructureMapGroupInput;
///
...
pub struct StructureMapGroupInput {
    ...
    /// source | target
    pub mode: crate::coded::Coded<crate::r4::codes::MapInputMode>,
...
///
/// ```ignore
/// use fhir::r4::resources::structure_map::StructureMapGroupRule;
///
...
///
/// ```ignore
/// use fhir::r4::resources::structure_map::StructureMapGroupRuleDependent;
///
...
///
/// ```
/// use fhir::r4::resources::structure_map::StructureMapGroupRuleSource;
///
...
pub struct StructureMapGroupRuleSource {
    ...
    pub list_mode: Option<crate::coded::Coded<crate::r4::codes::MapSourceListMode>>,
...
///
/// ```
/// use fhir::r4::resources::structure_map::StructureMapGroupRuleTarget;
///
...
pub struct StructureMapGroupRuleTarget {
    ...
    /// type | variable
    pub context_type: Option<crate::coded::Coded<crate::r4::codes::MapContextType>>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub list_mode: Vec<crate::coded::Coded<crate::r4::codes::MapTargetListMode>>,
    /// Primitive extension sibling for [`list_mode`](Self::list_mode) (FHIR `_listMode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_listMode")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    ...
    /// create | copy +
    pub transform: Option<crate::coded::Coded<crate::r4::codes::MapTransform>>,
...
///
/// ```
/// use fhir::r4::resources::structure_map::StructureMapGroupRuleTargetParameter;
///
...
///
/// ```
/// use fhir::r4::resources::structure_map::StructureMapStructure;
///
...
pub struct StructureMapStructure {
    ...
    pub mode: crate::coded::Coded<crate::r4::codes::MapModelMode>,
    /// Primitive extension sibling for [`mode`](Self::mode) (FHIR `_mode`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_mode")]
    pub mode_ext: Option<types::Element>,
