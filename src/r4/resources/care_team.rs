...
///
/// ```
/// use fhir::r4::resources::care_team::CareTeam;
///
...
pub struct CareTeam {
    ...
    pub status: Option<crate::coded::Coded<crate::r4::codes::CareTeamStatus>>,
...
///
/// ```
/// use fhir::r4::resources::care_team::CareTeamParticipant;
///
