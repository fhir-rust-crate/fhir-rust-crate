...
///
/// ```
/// use fhir::r4::resources::related_person::RelatedPerson;
///
...
///
/// ```
/// use fhir::r4::resources::related_person::RelatedPersonCommunication;
///
/// let value = RelatedPersonCommunication::default();
/// let json = ::serde_json::to_value(&value).unwrap();
