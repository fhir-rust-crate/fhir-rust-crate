...
///
/// ```ignore
/// use fhir::r4::resources::appointment::Appointment;
///
...
pub struct Appointment {
    ...
    pub status: crate::coded::Coded<crate::r4::codes::Appointmentstatus>,
...
///
/// ```
/// use fhir::r4::resources::appointment::AppointmentParticipant;
///
...
pub struct AppointmentParticipant {
    ...
    pub required: Option<crate::coded::Coded<crate::r4::codes::Participantrequired>>,
    ...
    pub status: crate::coded::Coded<crate::r4::codes::Participationstatus>,
    /// Primitive extension sibling for [`status`](Self::status) (FHIR `_status`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_status")]
    pub status_ext: Option<types::Element>,
