//! Parsing and precision-aware comparison for the FHIR R4 date/time
//! primitives.
//!
...
//! R4 newtypes and re-exports the shared types.
//!
//! ```
//! use fhir::r4::types::Date;
//! use fhir::r4::temporal::DatePrecision;
//!
