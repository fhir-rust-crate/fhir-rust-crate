...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinition;
///
...
pub struct ElementDefinition {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub representation: Vec<crate::coded::Coded<crate::r3::codes::PropertyRepresentation>>,
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionBase;
///
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionBinding;
///
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionConstraint;
///
...
pub struct ElementDefinitionConstraint {
    ...
    /// error | warning
    pub severity: crate::coded::Coded<crate::r3::codes::ConstraintSeverity>,
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionExample;
///
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionMapping;
///
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionSlicing;
///
...
pub struct ElementDefinitionSlicing {
    ...
    pub rules: crate::coded::Coded<crate::r3::codes::ResourceSlicingRules>,
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionSlicingDiscriminator;
///
...
pub struct ElementDefinitionSlicingDiscriminator {
    ...
    pub r#type: crate::coded::Coded<crate::r3::codes::DiscriminatorType>,
...
///
/// ```
/// use fhir::r3::types::element_definition::ElementDefinitionType;
///
...
pub struct ElementDefinitionType {
    ...
    pub target_profile: Option<types::Uri>,
    /// Primitive extension sibling for [`target_profile`](Self::target_profile) (FHIR `_targetProfile`):
    /// carries `id` and/or `extension` for the primitive value.
    #[serde(rename = "_targetProfile")]
    pub target_profile_ext: Option<types::Element>,

    /// contained | referenced | bundled - how aggregated
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub aggregation: Vec<crate::coded::Coded<crate::r3::codes::ResourceAggregationMode>>,
    ...
    pub versioning: Option<crate::coded::Coded<crate::r3::codes::ReferenceVersionRules>>,
