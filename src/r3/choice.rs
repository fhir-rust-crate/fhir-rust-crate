//! Support types for FHIR R3 `value[x]` choice elements.
//!
...
mod tests {
    use super::*;
    use crate::r3::types::{Boolean, Quantity, String as FhirString};
    ...
    fn validate_runs_on_active_variant() {
        ...
        let invalid = TestValue::Quantity(Box::new(Quantity {
            code: Some(crate::r3::types::Code(String::new())),
            ..Default::default()
        }));
