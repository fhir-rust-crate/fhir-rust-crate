...
///
/// let value = TestScriptRule::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptRuleParam::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptRulesetRule::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptRulesetRuleParam::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptSetupActionAssertRule::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptSetupActionAssertRuleParam::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptSetupActionAssertRuleset::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptSetupActionAssertRulesetRule::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = TestScriptSetupActionAssertRulesetRuleParam::default();
/// let json = ::serde_json::to_value(&value).unwrap();
