...
///
/// ```
/// use fhir::r3::resources::compartment_definition::CompartmentDefinition;
///
...
///
/// ```
/// use fhir::r3::resources::compartment_definition::CompartmentDefinitionResource;
///
/// let value = CompartmentDefinitionResource::default();
/// let json = ::serde_json::to_value(&value).unwrap();
