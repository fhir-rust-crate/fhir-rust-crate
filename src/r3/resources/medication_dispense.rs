...
///
/// ```
/// use fhir::r3::resources::medication_dispense::MedicationDispense;
///
...
pub struct MedicationDispense {
    ...
    /// stopped
    pub status: Option<crate::coded::Coded<crate::r3::codes::MedicationDispenseStatus>>,
    ...
    /// The `MedicationDispense.notDoneReason[x]` choice element (0..1); see [`MedicationDispenseNotDoneReason`].
    #[serde(flatten)]
    pub not_done_reason: Option<MedicationDispenseNotDoneReason>,
...
///
/// ```
/// use fhir::r3::resources::medication_dispense::MedicationDispensePerformer;
///
...
///
/// ```
/// use fhir::r3::resources::medication_dispense::MedicationDispenseSubstitution;
///
...
/// The `MedicationDispense.notDoneReason[x]` choice element (see `spec/11-choice-types.md`).
#[derive(Debug, Clone, PartialEq, Eq, fhir_derive_macros::FhirChoice, Validate)]
#[fhir_version("r3")]
#[allow(clippy::large_enum_variant)]
pub enum MedicationDispenseNotDoneReason {
    /// `notDoneReasonCodeableConcept` variant.
    #[fhir("notDoneReasonCodeableConcept")]
    CodeableConcept(Box<types::CodeableConcept>),
    /// `notDoneReasonReference` variant.
    #[fhir("notDoneReasonReference")]
    Reference(Box<types::Reference>),
}
