...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrder;
///
...
pub struct NutritionOrder {
    ...
    pub status: Option<crate::coded::Coded<crate::r3::codes::NutritionRequestStatus>>,
...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrderEnteralFormula;
///
...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrderEnteralFormulaAdministration;
///
...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrderOralDiet;
///
...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrderOralDietNutrient;
///
...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrderOralDietTexture;
///
...
///
/// ```
/// use fhir::r3::resources::nutrition_order::NutritionOrderSupplement;
///
