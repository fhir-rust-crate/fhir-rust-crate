...
///
/// let value = ConsentActor::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = ConsentExcept::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = ConsentExceptActor::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
///
/// let value = ConsentExceptData::default();
/// let json = ::serde_json::to_value(&value).unwrap();
