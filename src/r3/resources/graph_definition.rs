...
///
/// ```
/// use fhir::r3::resources::graph_definition::GraphDefinition;
///
...
pub struct GraphDefinition {
    ...
    pub start: crate::coded::Coded<crate::r3::codes::ResourceTypes>,
...
///
/// ```ignore
/// use fhir::r3::resources::graph_definition::GraphDefinitionLink;
///
/// let value = GraphDefinitionLink::default();
/// let json = ::serde_json::to_value(&value).unwrap();
...
pub struct GraphDefinitionLink {
    ...
    pub target: ::vec1::Vec1<GraphDefinitionLinkTarget>,
}
...
///
/// ```
/// use fhir::r3::resources::graph_definition::GraphDefinitionLinkTarget;
///
/// let value = GraphDefinitionLinkTarget::default();
/// let json = ::serde_json::to_value(&value).unwrap();
/// let back: GraphDefinitionLinkTarget = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
...
///
/// ```
/// use fhir::r3::resources::graph_definition::GraphDefinitionLinkTargetCompartment;
///
/// let value = GraphDefinitionLinkTargetCompartment::default();
/// let json = ::serde_json::to_value(&value).unwrap();
/// let back: GraphDefinitionLinkTargetCompartment = ::serde_json::from_value(json).unwrap();
/// assert_eq!(value, back);
/// ```
#[serde_with::skip_serializing_none]
#[derive(Debug, Default, Clone, Serialize, Deserialize, PartialEq, Eq, Validate)]
...
pub struct GraphDefinitionLinkTargetCompartment {
    ...
    pub code: crate::coded::Coded<crate::r3::codes::CompartmentType>,
    ...
    pub rule: crate::coded::Coded<crate::r3::codes::GraphCompartmentRule>,
