...
///
/// ```
/// use fhir::r3::resources::service_definition::ServiceDefinition;
///
/// let value = ServiceDefinition::default();
/// let json = ::serde_json::to_value(&value).unwrap();
/// let back: ServiceDefinition = ::serde_json::from_value(json).unwrap();
